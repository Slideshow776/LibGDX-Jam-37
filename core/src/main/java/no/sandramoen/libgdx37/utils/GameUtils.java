...
public class GameUtils {
    ...
    public static void saveGameState() {
        ...
        no.sandramoen.libgdx37.utils.BaseGame.preferences.putFloat("soundVolume", no.sandramoen.libgdx37.utils.BaseGame.soundVolume);
        no.sandramoen.libgdx37.utils.BaseGame.preferences.putFloat("voiceVolume", no.sandramoen.libgdx37.utils.BaseGame.voiceVolume);
    ...
    public static void loadGameState() {
        ...
        no.sandramoen.libgdx37.utils.BaseGame.musicVolume = no.sandramoen.libgdx37.utils.BaseGame.preferences.getFloat("musicVolume");
    ...
    public static void setMusicVolume(float volume) {
        ...
        no.sandramoen.libgdx37.utils.BaseGame.musicVolume = volume;
